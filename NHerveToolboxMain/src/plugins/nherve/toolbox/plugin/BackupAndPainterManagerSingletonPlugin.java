...
/**
 * The Class BackupAndPainterManagerSingletonPlugin.
 * 
 * @param <O>
 *            the generic type
 * @param <P>
 ...
 */
public abstract class BackupAndPainterManagerSingletonPlugin<O, P extends Painter> extends BackupSingletonPlugin<O> implements PainterManager<P>, PainterFactory<P> {
	...
	/* (non-Javadoc)
	 * @see plugins.nherve.toolbox.plugin.BackupSingletonPlugin#startPlugin()
	 */
	@Override
