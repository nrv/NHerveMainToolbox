 ...
 */
public interface LocalDescriptor<T extends Segmentable, S extends Signature> extends Descriptor<T> {
	 ...
	 */
	S extractLocalSignature(T img, SupportRegion reg) throws SignatureException;
